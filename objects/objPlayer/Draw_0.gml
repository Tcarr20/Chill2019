...
else if (headAttackSprites[myFace] != -1 && myState == PlayerState.Attack) { draw_sprite_ext(headAttackSprites[myFace], image_index, x, y, image_xscale, image_yscale, image_angle, image_blend, image_alpha); }
