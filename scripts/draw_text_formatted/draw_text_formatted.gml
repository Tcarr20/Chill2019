...
while(string_length(text) > 0)
{
	...
	if (_chunk_end >= 0)
	{
		...
		{
			//Error
			debug_popup("Malformed operator at\nNo closing operator");
			break;
		}
		...
		while(string_length(_op_text) > 0)
		{
			...
			{
				//Error
				debug_popup("Malformed operator at\nNo equals in operator tag["+string_char_at(_tag_text, 2)+"]")
				break;
			}
			...
			switch(string_char_at(_tag_text, 1))
			{
				case "C":
					...
					switch(_tag_text)
					{
						case "red": _draw_col = cc_red; break;
						case "green": _draw_col = cc_green; break;
						case "blue": _draw_col = cc_blue; break;
						case "lblue": _draw_col = cc_lblue; break;
						case "white": _draw_col = c_white; break;
						case "black": _draw_col = c_black; break;
						case "gray": _draw_col = cc_gray; break;
						default:
							//Error
							debug_popup("Malformed operator at\nInvalid Color assignment ["+_tag_text+"]");
						break;
					}
				break;
				case "S":
					...
					switch(_tag_text)
					{
						...
						default:
							//Error
							debug_popup("Malformed operator at\nInvalid Shadow assignment ["+_tag_text+"]");
						break;
					}
				break;
				case "M":
					...
					switch(_tag_text)
					{
						...
						default:
							//Error
							debug_popup("Malformed operator at\nInvalid Move assignment ["+_tag_text+"]");
						break;
					}
				break;
				default:
					//Error
					debug_popup("Malformed operator at\nInvalid tag identifier ["+string_char_at(_op_text, 1)+"]");
				break;
			}
